...
{
    'name': 'Project Modifications Stauner',
    'version': '18.0.0.0.2',
    'summary': "Modifications for Project. #stauner #systee",
    ...
    'data': [
        ...
        'views/product_template_sale_project_view.xml',
        'views/project_views.xml',
        'views/project_search_view.xml',
    ],
    'description': """
                   """,
}
