...
class ProductTemplate(models.Model):
    ...
    'ptp_bat_kapacita_unit',
    'ptp_bat_kapacita_value',
    'ptp_bat_napeti',
    'ptp_bat_napeti_full_value',
    'ptp_bat_napeti_unit',
    'ptp_bat_napeti_value',
    'ptp_bat_typ',
    'ptp_bip_napeti_uce',
    'ptp_bip_napeti_uce_full_value',
    'ptp_bip_napeti_uce_unit',
    'ptp_bip_napeti_uce_value',
    'ptp_bip_proud_ice',
    'ptp_bip_proud_ice_full_value',
    'ptp_bip_proud_ice_unit',
    'ptp_bip_proud_ice_value',
    'ptp_bip_typ',
    'ptp_blu_typ',
    'ptp_cap',
    'ptp_cap_dielectric',
    ...
    'ptp_dis_typ',
    'ptp_dps_material',
    'ptp_dps_pocet_vrstev',
    'ptp_dps_pocet_vrstev_full_value',
    'ptp_dps_pocet_vrstev_unit',
    'ptp_dps_pocet_vrstev_value',
    'ptp_dps_povrchova_uprava',
    'ptp_dps_rozmery',
    'ptp_dps_rozmery_full_value',
    'ptp_dps_rozmery_unit',
    'ptp_dps_rozmery_value',
    'ptp_dps_tloustka',
    'ptp_dps_tloustka_full_value',
    'ptp_dps_tloustka_unit',
    'ptp_dps_tloustka_value',
    'ptp_drb_montaz',
    'ptp_drb_pocet_clanku',
    'ptp_drb_pocet_clanku_full_value',
    'ptp_drb_pocet_clanku_unit',
    ...
    'ptp_hdd_kapacita_unit',
    'ptp_hdd_kapacita_value',
    'ptp_hdd_typ',
    'ptp_imp',
    'ptp_imp_full_value',
    'ptp_imp_unit',
    ...
    'ptp_nap_pocet_pinu_unit',
    'ptp_nap_pocet_pinu_value',
    'ptp_nap_roztec_kontaktu',
    'ptp_nap_roztec_kontaktu_full_value',
    'ptp_nap_roztec_kontaktu_unit',
    'ptp_nap_roztec_kontaktu_value',
    ...
    'ptp_pin_pocet_pinu_unit',
    'ptp_pin_pocet_pinu_value',
    'ptp_pin_roztec_kontaktu',
    'ptp_pin_roztec_kontaktu_full_value',
    'ptp_pin_roztec_kontaktu_unit',
    'ptp_pin_roztec_kontaktu_value',
    'ptp_pin_typ',
    'ptp_plc_typ',
    'ptp_poj_napeti',
    'ptp_poj_napeti_full_value',
    'ptp_poj_napeti_unit',
    'ptp_poj_napeti_value',
    'ptp_poj_proud',
    ...
    'ptp_uni_napeti_vds_unit',
    'ptp_uni_napeti_vds_value',
    'ptp_uni_proud_ids',
    'ptp_uni_proud_ids_full_value',
    'ptp_uni_proud_ids_unit',
    'ptp_uni_proud_ids_value',
    'ptp_uni_typ_value',
    'ptp_usb_typ',
    'ptp_usm_if',
